...
urlpatterns = [
    ...
    path('top_doctors/', TopDoctorsListCreateAPIView.as_view(), name='top_doctors_list_create'),
    path('top_doctors/<int:top_doctor_id>/', TopDoctorsDetailAPIView.as_view(), name='top_doctors_detail'),
