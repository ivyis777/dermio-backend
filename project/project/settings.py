...
ALLOWED_HOSTS = ['35.154.40.196','localhost']
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'app.controllers.authentication_backend.CustomJWTAuthentication',  # Path to your custom JWT authentication
    ),
...
SIMPLE_JWT = {
    'AUTH_HEADER_TYPES': ('JWT', 'Bearer'),  # Define the accepted token prefix
    # You can customize other settings as needed
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'rameshrammi345@gmail.com'
EMAIL_HOST_PASSWORD = 'hdkh ojnd fdvz kley'
DEFAULT_FROM_EMAIL = 'ramesh.m7558@gmail.com'
